...
namespace EnigmaHub.Domain.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SDI = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerMarketingDatas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerMarketingDatas_Customers_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerMarketingDatas_CustomerId",
                table: "CustomerMarketingDatas",
                column: "CustomerId");
        }
